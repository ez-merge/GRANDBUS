/*
  # Add seat locking and booking validation

  1. Changes
    - Add function to check seat availability
    - Add trigger for seat validation
...
BEGIN
  ...
  -- Automatically unlock the seats after successful booking
  PERFORM manage_seat_locks(
    NEW.bus_id,
    NEW.route_id,
    NEW.seats,
    'unlock'
...
-- Create indexes for faster seat lookups
